...
//            ->andReturn(Mockery::mock(\Mel\Auth\OAuthClient::class));
    ...
    public function testShouldCreateHttpClientInstance()
    {
        $httpClient = new _HttpClient($this->getMel());

        $this->assertAttributeInstanceOf(Mel::class, 'mel', $httpClient);
        $this->assertAttributeInstanceOf(\Http\Client\HttpClient::class, 'httpClient', $httpClient);
    }
    ...
    public function testSendValidRequest()
    {
        ...
        $adapter->setDefaultResponse($rawResponse);

        $httpClient = new _HttpClient($this->getMel(), $adapter);

        $request = $this->createRequest('POST', '/');
        $response = $httpClient->sendRequest($request);

        $this->assertInstanceOf(\Mel\Http\Responses\ResponseInterface::class, $response);
